...
@push('styles')
<style>.card-header-flex{display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px}.card-header-left{display:flex;align-items:center;gap:12px}.card-header-right{display:flex;align-items:center;gap:8px}.kandang-label{display:inline-flex;align-items:center;justify-content:center;padding:4px 14px;border-radius:20px;background:var(--accent-copper);color:#fff;font-weight:700;font-size:12px;letter-spacing:0.5px;flex-shrink:0}.size-badge-sm{display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;border-radius:8px;background:var(--accent-copper);color:#fff;font-weight:700;font-size:11px;flex-shrink:0}.size-name{font-size:13px;color:var(--text-primary);margin-left:8px}.sortir-table th{font-size:11px;padding:14px 12px;white-space:nowrap}.sortir-table th.num,.sortir-table td.num{text-align:right;font-variant-numeric:tabular-nums}.sortir-table td{padding:12px;vertical-align:middle;font-size:13px}.sortir-table td.num.harga{color:var(--gain)}.sortir-table td.num.nilai{color:var(--gain);font-weight:600}.btn-aksi{display:inline-flex;align-items:center;justify-content:center;width:32px;height:32px;border:none;border-radius:8px;font-size:14px;cursor:pointer;transition:all 0.2s;text-decoration:none}.btn-aksi.hapus{background:rgba(239,68,68,0.15);color:#ef4444}.btn-aksi.hapus:hover{background:rgba(239,68,68,0.3);transform:scale(1.1)}.total-row{background:var(--bg-card-hover)!important}.total-row td{padding:14px 12px!important;border-top:2px solid var(--border-color)}.total-label{font-weight:700;font-size:12px;text-transform:uppercase;letter-spacing:0.5px;color:var(--text-secondary)}.total-val{font-weight:700;font-size:14px;color:var(--text-primary)}.total-val.nilai{color:var(--gain)}@media(max-width:768px){.sortir-table thead{display:none}.sortir-table tbody tr{display:block;background:var(--bg-card);border:1px solid var(--border-color);border-radius:14px;padding:14px 16px;margin-bottom:12px}.sortir-table td{display:flex;justify-content:space-between;align-items:center;padding:8px 0;border:none;gap:12px;text-align:right}.sortir-table td::before{content:attr(data-label);font-size:11px;font-weight:600;color:var(--text-muted);text-transform:uppercase;letter-spacing:0.5px;flex-shrink:0;text-align:left}.sortir-table td.num{text-align:right}.size-badge-sm{display:none}.total-row td::before{display:none}}.modal-overlay{position:fixed;inset:0;background:rgba(0,0,0,0.6);display:none;align-items:center;justify-content:center;z-index:1000;padding:20px}.modal-overlay.active{display:flex}.modal{background:var(--bg-card);border-radius:16px;width:100%;max-width:480px;border:1px solid var(--border-color)}.modal-header{display:flex;align-items:center;justify-content:space-between;padding:20px 24px;border-bottom:1px solid var(--border-color)}.modal-header h2{font-size:18px;font-weight:600;margin:0}.modal-close{background:none;border:none;color:var(--text-secondary);font-size:24px;cursor:pointer;padding:4px 8px;line-height:1}.modal-body{padding:24px}.modal-footer{display:flex;gap:12px;justify-content:flex-end;padding:16px 24px;border-top:1px solid var(--border-color)}@media(max-width:540px){.modal{max-width:100%;border-radius:12px}}</style>@endpush
