...
<head>
    ...
    <style>.market-table,.market-table>thead,.market-table>tbody,.market-table>tbody>tr,.market-table>tbody>tr>td,.market-table>thead>tr>th{display:revert!important}.market-table>tbody>tr>td::before{content:none!important;display:none!important}.market-table{cursor:default!important}@media(max-width:768px){.market-table,.market-table>thead,.market-table>tbody,.market-table>tbody>tr,.market-table>tbody>tr>td,.market-table>thead>tr>th{display:revert!important}.market-table>thead{display:table-header-group!important}.market-table>tbody>tr{display:table-row!important;background:transparent!important;border:none!important;border-radius:0!important;padding:0!important;margin:0!important;overflow:visible!important;cursor:default!important;transform:none!important}.market-table>tbody>tr:active{transform:none!important}.market-table>tbody>tr>td{display:table-cell!important;padding:16px!important;border-bottom:1px solid var(--border)!important}.market-table>tbody>tr>td::before{content:none!important;display:none!important}}</style>
    @stack('styles')
</head>
<body>
